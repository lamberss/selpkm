...
class Database(object):
    def __init__(self, path: Union[str, pathlib.Path], initialize: bool = True):
        self._path = path
    ...
    def _get_row(self, row_name: str, exception: DatabaseException, id: Union[int, None] = None, name: Union[str, None] = None) -> dict:
    ...
    def _get_rows(self, row_name: str, where: str = '') -> List[dict]:
    ...
    def add_container(self, name: str, parent_id: Union[int, None] = None, parent_name: Union[str, None] = None) -> int:
        timestamp = get_timestamp()
    ...
    def add_note(self, name: str, description: Union[str, None] = None, container_id: Union[int, None] = None, container_name: Union[str, None] = None) -> int:
        timestamp = get_timestamp()
    ...
    def get_container(self, id: Union[int, None] = None, name: Union[str, None] = None) -> dict:
    ...
    def get_notes(self, container_id: Union[int, None] = None, container_name: Union[str, None] = None) -> List[dict]:
        where = ''
